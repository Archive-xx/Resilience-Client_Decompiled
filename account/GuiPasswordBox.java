...
public class GuiPasswordBox extends Gui
{
    ...
    public GuiPasswordBox(final FontRenderer par1FontRenderer, final int par2, final int par3, final int par4, final int par5) {
        this.field_146216_j = "";
    ...
    public void drawTextBox() {
        if (this.func_146176_q()) {
            ...
            if (var4.length() > 0) {
                ...
                var9 = this.field_146211_a.drawStringWithShadow(var10.replaceAll("(?s).", "*"), (float)var7, (float)var8, var1);
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                this.field_146211_a.drawStringWithShadow(var4.substring(var2), (float)var9, (float)var8, var1);
            }
            if (var6) {
                if (var11) {
                    ...
                    this.field_146211_a.drawStringWithShadow("_", (float)var12, (float)var8, var1);
                }
            }
            if (var3 != var2) {
