...
public class GuiAdd extends GuiScreen
{
    ...
    public GuiAdd(final GuiScreen screen) {
        this.parent = screen;
    }
    ...
    public void initGui() {
        ...
        this.buttonList.add(new ResilienceButton(0, (float)(Resilience.getInstance().getInvoker().getWidth() / 2 - 102), (float)(Resilience.getInstance().getInvoker().getHeight() / 2 + 25), 204.0f, 20.0f, "Add"));
    ...
    protected void actionPerformed(final GuiButton par1) {
        ...
        if (par1.id == 0) {
            Account.accountList.add(new Account(this.usernameBox.getText(), this.passwordBox.getText()));
