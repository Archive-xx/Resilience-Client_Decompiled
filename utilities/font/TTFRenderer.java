...
public class TTFRenderer
{
    ...
    public TTFRenderer(final String fontName, final int fontType, final int size) {
        this(fontName, fontType, size, 0.0f);
    }
    
    public TTFRenderer(final String fontName, final int fontType, final int size, final float kerning) {
