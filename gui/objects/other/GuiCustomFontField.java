...
public class GuiCustomFontField extends Gui
{
    private String text;
    private final TTFRenderer field_146211_a;
    ...
    public GuiCustomFontField(final TTFRenderer par1FontRenderer, final int par2, final int par3, final int par4, final int par5) {
        this.text = "";
        this.field_146216_j = "";
    ...
    public void drawTextBox() {
        if (this.func_146176_q()) {
            ...
            if (var4.length() > 0) {
                ...
                var9 = this.field_146211_a.drawStringWithShadow(var10, (float)var7, (float)(var8 - 2), var1);
                this.text = var10;
            }
            ...
            if (var4.length() > 0 && var5 && var2 < var4.length()) {
                this.field_146211_a.drawStringWithShadow(var4.substring(var2), (float)var9, (float)(var8 - 2), var1);
            }
            if (var6 && var11) {
                Gui.drawRect(var12, var8 - 1, var12 + 1, (int)(var8 + 1 + this.field_146211_a.getHeight(this.text)), -3092272);
            }
            if (var3 != var2) {
                final int var13 = (int)(var7 + this.field_146211_a.getWidth(var4.substring(0, var3)));
                this.func_146188_c(var12, var8 - 1, var13 - 1, (int)(var8 + 1 + this.field_146211_a.getHeight(this.text)));
            }
        }
    }
    ...
    private void func_146188_c(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_) {
        ...
        var6.addVertex((double)p_146188_1_, (double)p_146188_4_, 0.0);
        var6.addVertex((double)p_146188_3_, (double)p_146188_4_, 0.0);
        var6.addVertex((double)p_146188_3_, (double)p_146188_2_, 0.0);
        var6.addVertex((double)p_146188_1_, (double)p_146188_2_, 0.0);
        var6.draw();
        GL11.glDisable(3058);
        GL11.glEnable(3553);
    }
    ...
    public void func_146199_i(int p_146199_1_) {
        ...
        if (this.field_146211_a != null) {
            ...
            if (p_146199_1_ == this.field_146225_q) {
                this.field_146225_q -= this.field_146211_a.trimStringToWidth(this.field_146216_j, var3).length();
            }
            if (p_146199_1_ > var5) {
    ...
    public void setCanLoseFocus(final boolean flag) {
        this.func_146205_d(flag);
    }
    ...
    public void setEnableBackgroundDrawing(final boolean flag) {
        this.func_146185_a(flag);
    }
}
