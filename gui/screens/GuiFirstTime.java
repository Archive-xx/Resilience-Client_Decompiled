...
public class GuiFirstTime extends GuiScreen
{
    ...
    public void drawScreen(final int i, final int j, final float f) {
        ...
        Resilience.getInstance().getPanelTitleFont().drawCenteredString("Welcome to Resilience!", (float)(Resilience.getInstance().getInvoker().getWidth() / 2), 8.0f, -16755201);
        Resilience.getInstance().getStandardFont().drawCenteredString("Since this is your first time, please configure your client.", (float)(Resilience.getInstance().getInvoker().getWidth() / 2), 26.0f, -1);
        Resilience.getInstance().getStandardFont().drawCenteredString("You can change any of these settings in the client options at any time.", (float)(Resilience.getInstance().getInvoker().getWidth() / 2), 36.0f, -1);
